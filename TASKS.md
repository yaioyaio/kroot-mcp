...
- [x] 플러그인 매니저 및 레지스트리 ✅
  - [x] 중앙 집중식 플러그인 관리 ✅ (src/plugins/manager.ts - 550줄)
...
## 마일스톤 6: 안정화 및 리팩토링 (13-14주차) 🔄
**목표**: 프로덕션 배포 가능한 상태로 코드베이스 안정화
**상태**: 진행중 (2025-08-05~)

### TypeScript 컴파일 오류 수정
- [ ] 141개 TypeScript 컴파일 오류 해결
  - [ ] `exactOptionalPropertyTypes` 관련 오류 수정
  - [ ] undefined 타입 처리 개선
  - [ ] import 경로 및 타입 정의 수정
  - [ ] 타입 안정성 확보
- [ ] 의존성 정리 및 순환 참조 해결
- [ ] TypeScript strict 모드 완전 준수

### 메인 서버 파일 모듈화
- [ ] src/server/index.ts 리팩토링 (7,107줄 → 500줄 이하)
  - [ ] MCP 도구별 모듈 분리
