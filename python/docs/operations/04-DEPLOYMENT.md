...
# 프로덕션 최적화 빌드
NODE_ENV=production poetry build
...
// ~/.config/mcp/servers.json
{
  "devflow-monitor": {
    ...
    "cwd": "/Users/YOUR_USERNAME/.config/mcp/devflow-monitor",
    "env": {
...
### 5.2 보안 설정
```python
# src/devflow_monitor/security/__init__.py
