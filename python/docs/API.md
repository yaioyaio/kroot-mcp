...
```json
{
  "project": {
    ...
    "version": "0.1.0",
    "status": "active",
    "lastActivity": "2026-02-03T06:00:00Z"
  },
  "milestones": {
  ...
  "activities": [
    {
      "id": "activity-1",
      "type": "file:created",
      "timestamp": "2026-02-03T05:45:30Z",
      "source": "FileMonitor",
      "data": {
        "path": "/src/devflow_monitor/events/engine.py",
        "action": "created",
        "size": 12845
      }
    },
    {
      "id": "activity-2", 
      "type": "git:committed",
      "timestamp": "2026-02-03T05:30:15Z",
      "source": "GitMonitor",
      "data": {
...
```json
{
  "eventEngine": {
    "statistics": {
      ...
      "eventsPerHour": 12.5,
      "lastEventTime": "2026-02-03T05:59:45Z"
    },
    "queueSize": 0,
    "subscriberCount": 3
  },
...
**참고:** 이 문서는 DevFlow Monitor MCP (Python) 기준으로 작성되었습니다. 최신 버전의 변경사항은 [CHANGELOG.md](../CHANGELOG.md)를 확인하세요.